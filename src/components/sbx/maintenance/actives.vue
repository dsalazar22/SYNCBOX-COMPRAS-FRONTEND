<template>
    <div>
        ...
        <h4 class="font-weight-bold py-3 mb-4">Registro de Activos</h4>
        ...
        <div class="row">
            ...
            <b-row>
                ...
                <!-- BOTONES PARA CREAR NUEVOS REGISTROS Y PARA OPCION DE AYUDA cfmnt/acf/0-->
                <b-col md="2" class="d-flex justify-content-center my-1">
                    <b-btn variant="outline-success icon-btn" class="btn-md"  v-b-modal.modals-default :to="{path:'acf/0'}"><i class="ion ion-md-add"></i></b-btn>&nbsp;
            ...
            <!-- OPCIONES DE BUSQUEDA Y BOTONES PARA CREAR NUEVOS REGISTROS -->
                ...
                <b-table small show-empty stacked="md" :items="tableData" :fields="columns" :current-page="currentPage" :per-page="perPage" 
                    ...
                    <template v-slot:cell(edit)="row">
                        <div class="text-left">
                            <b-btn variant="outline-success borderless icon-btn" class="btn-xs" :to="{path:'acf/'+row.item.assets_id}"><i class="ion ion-md-create"></i></b-btn>
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small> Total Registro de Activos: {{this.totalRows}} </small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <b-modal id="modals-top" v-model="showFormulario"  class="modal-center" size="md">
            ...
            Administrar <span class="font-weight-light">Registro de Activos</span><br>
        ...
        data: () => ({
            ...
            /// Columnas de las tablas
                columns: [
                    ...
                    {key:'description', label:"Categoría"},
                    {key:'active_nro', label:"Numero de Activo"},
