<template>
    <div>
    <h4 class="font-weight-bold py-3 mb-4">Autorizacion de Solicitudes</h4>
            ...
            <template v-slot:cell(edit)="row">
                <div class="text-left">
                    <b-dd variant="default" text="Acciones" :right="isRTL" size="xs">
                        <b-dd-item @click.prevent="openActionConfirm(row.item,'AC')"  > <i class="fas fa-exclamation text-warning"></i> &nbsp; Liberar</b-dd-item>
                        <b-dd-divider></b-dd-divider>
                        <b-dd-item  @click.prevent="openActionConfirm(row.item,'NA')" > <i class="ion ion-md-close text-danger"></i> &nbsp; No Autorizar</b-dd-item>
                    </b-dd>
...
export default {
    ...
    metaInfo: {
        title:"Autorizacion de Solicitudes",
    },
    data() {
        return {
            actionConfirm:false,
    ...
    methods: {
        ...
        loadInfo(){
            infomainten.plan("CR",'plan-request','select-state').then(data =>{
