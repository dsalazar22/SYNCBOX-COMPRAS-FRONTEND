<template>
    <div>
    <h4 class="font-weight-bold py-3 mb-4">Solicitudes Activas</h4>
            ...
            <template v-slot:cell(edit)="row">
                <div class="text-left">
                    <b-dd variant="default" text="Acciones" :right="isRTL" size="xs">
                        ...
                        <b-dd-item  @click.prevent="openActionConfirm(row.item,'PV')" > <i class="ion ion-md-close text-danger"></i> &nbsp; Verificar</b-dd-item>
                    </b-dd>
