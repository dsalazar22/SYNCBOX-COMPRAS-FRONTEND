    ...
    <div>
        ...
        <b-modal id="modals-top" v-model="showFormulario"  class="modal-center" size="md">
            ...
            <fieldset class="demo-vertical-spacing-sm">
                ...
                <b-form-group label="Teléfono" :feedback="objState.message" >
                    <b-input placeholder="Teléfono" v-model.trim="objInfo.phone"/>
                </b-form-group>
                <b-form-group label="Dirección" :feedback="objState.message" >
                    <b-input placeholder="Dirección" v-model.trim="objInfo.address" />
                </b-form-group>
                <b-form-group label="Correo Electrónico" :feedback="objState.message" >
                    <b-input placeholder="Correo Electrónico" v-model.trim="objInfo.email" />
                </b-form-group>
