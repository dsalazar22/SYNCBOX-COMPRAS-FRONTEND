<template>
    <div>
        ...
        <div v-if="!finished_basic_order">
            ...
            <div v-if="show_info_details == 'tree'">
...
export default {
    ...
    methods: {
        crear_orden(){
            // console.log(this.product_ppal, this.selected_info_order_type, this.selected_listDefinitionBOM, this.selected_listDefinitionRoute)
            let info_to_send = {
