<template>
    <div>
        ...
        <h4 class="font-weight-bold py-3 mb-4">Reporte Manual de Operaciones</h4>
                ...
                <b-table small show-empty stacked="md" :items="tableData" :fields="columns" :current-page="currentPage" :per-page="perPage" 
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small> Total reporte Manual: {{this.totalRows}} </small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <b-modal id="modals-top" v-model="showFormulario"  centered size="md">
            ...
            Administrar <span class="font-weight-light">Reporte Manual de Operaciones</span><br>
            ...
            <fieldset class="demo-vertical-spacing-sm">
                <b-form-group :feedback="objState.message" label="Hora de Inicio" horizontal :label-cols="5">
                ...
                <b-form-group :feedback="objState.message" label="Hora Fin" horizontal :label-cols="5">
                    <!-- <timeselector v-model="objInfo.default_start_hour"></timeselector> -->
                    <vue-clock-picker v-model="objInfo.default_end_hour"></vue-clock-picker>
                </b-form-group>
                ...
                <b-form-group :feedback="objState.message" label="Cantidad Producida" horizontal>
                    <b-input placeholder="Cantidad Producida" v-model.trim="objInfo.units_produced" :state="objState.units_produced" v-on:input="objState.units_produced = 'valid'; objState.units_produced= objInfo.units_produced==''?'invalid':'valid'"/>
                </b-form-group>
            </fieldset>
...
<script>
    ...
    export default {
        ...
        metaInfo: {
            title: 'Reporte Manual de Operaciones'
        },
        components: {
            VueMarkdown,
            SweetModal,
        ...
        data: () => ({
            ...
            /// Columnas de las tablas
                columns: [
                    ...
                    {key:'star_time', label:"Hora Inicio"},
                    {key:'end_time', label:"Hora Fin"},
                    {key:'description', label:"Descripción"},
                    {key:'units_produced', label:"Unidades Producidas"},
                    {key:'total_scrap', label:"Defectuosas"},
