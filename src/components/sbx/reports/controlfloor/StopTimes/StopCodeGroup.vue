    ...
    export default {
        ...
        methods: {
            download (){
                ...
                var doc = CrearPDF(titlePDF, infoFecha, columns, this.items2)
                ...
                doc.save('infoParosGruposCT.pdf');
                ...
                ///Detalle paros
                    ...
                    .then(resultado =>{
                        ...
                        if(resultado != undefined){
                            result = JSON.parse(JSON.stringify(resultado.detalle).replace(/,0|_/g,',null').replace(/\[0|_/g,'[null'))
                        }
