        ...
        <!-- <div class="content-heading">
            <div>
                ...
                <h4 class="font-weight-bold py-3 mb-1">
                    Disponibilidad Por Centros de Trabajo
...
export default {
  ...
  data() {
    return {
            ...
            fields: [
                ...
                {
                    key: 'tt',
                    label: 'Tiempo Total (m)',
                },
                {
                    key: 'si_mmto',
                    label: 'Tiempo Mantenimiento (m)',
                },
                {
                    key: 'disponibilidad',
  ...
  methods: {
    ...
    cargarDatos: function(valor) {
      ...
      this.$http
        .get(
            reports+"/obtenerdisponibilidadmtto/" + paramtros
        )
        .then(respuesta => {
        ...
        .then(usuarios => {
            ...
            //     info_chart.push({name:element.name + ' (' + element.y + ')', y: element.y })
            // }

            // console.log(totales_minutes, ciclos_paros)
          this.donutdata = JSON.parse(usuarios);
