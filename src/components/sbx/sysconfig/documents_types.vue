<template>
    <div>
        ...
        <h4 class="font-weight-bold py-3 mb-4">Tipos de Documentos</h4>
        ...
        <div class="row">
            ...
            <b-row>
                ...
                <b-col md="2" class="d-flex justify-content-center my-1">
                    <b-btn variant="outline-success icon-btn" class="btn-md" v-if="check_access('admin_documents_types', 'c')"  v-b-modal.modals-default @click.prevent="edit_code=true; addData();objState={}"><i class="ion ion-md-add"></i></b-btn>&nbsp;
            ...
            <!-- OPCIONES DE BUSQUEDA Y BOTONES PARA CREAR NUEVOS REGISTROS -->
                ...
                <b-table small show-empty stacked="md" :items="tableData" :fields="columns" :current-page="currentPage" :per-page="perPage" 
                    ...
                    <template v-slot:cell(edit)="row">
                        <div class="text-left">
                            <b-btn variant="outline-success borderless icon-btn" class="btn-xs" v-if="check_access('admin_documents_types', 'c')" @click.prevent="edit_code=false; data_change(row.item,'edit')"><i class="ion ion-md-create"></i></b-btn>
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small> Total Tipos de Documentos: {{this.totalRows}} </small>
                    </div>
                </div>
            </div>
        </div>
        ...
        ///Eventos CRUD
            submit: function(){
                if(this.validate_content()){
                    infosysconfig.documenttype(this.objInfo, this.selected_code === "" ? "insert" : "update").then(data => {
                        if (data.status === 202){
            ...
            deleteRecord: function(){
                infosysconfig.documenttype(this.objInfo, "delete").then(data => {
                    if (data.status === 202){
