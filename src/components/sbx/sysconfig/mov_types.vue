<template>
    <div>
        ...
        <h4 class="font-weight-bold py-3 mb-4">Tipos de Movimientos</h4>
                ...
                <b-table small show-empty stacked="md" :items="tableData" :fields="columns" :current-page="currentPage" :per-page="perPage" 
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small> Total Tipos de Movimientos: {{this.totalRows}} </small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-inline-block">
            <sweet-modal icon="error" title="Borrar registro" ref="errorWithButtonAlert">
                ...
                <div class="w-100 text-center">
                    El registro será borrado de forma lógica, pero su información será visible en los distintos movimientos generados. 
                </div>
        ...
        <b-modal id="modals-top" v-model="showFormulario"  class="modal-center" size="md">
            <div slot="modal-title">
                Administrar <span class="font-weight-light">Tipos de Movimientos</span><br>
            ...
            <fieldset class="demo-vertical-spacing-sm">
                <b-form-group :feedback="objState.message">
                    <b-input placeholder="Codigo del Movimiento" v-model.trim="objInfo.code" :disabled="variantSaveButton!='success'"/>
                </b-form-group>    
                <b-form-group :feedback="objState.message">
                    <b-input placeholder="Nombre del Movimiento" v-model.trim="objInfo.description"/>
                </b-form-group>    
               <!-- <div> -->
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.is_income" :disabled="variantSaveButton!='success'">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Es un movimiento de Ingreso de Producto?</span>
                </label>
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.is_delivery" @change="changeMovesTypes('delivery', objInfo)">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Movimiento Entrega de Pedidos?</span>
                </label>
               <!-- </div>
               <div> -->
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.warehouse_required" @change="changeMovesTypes('warehouse',objInfo); ">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Es un Traslado entre Bodegas?</span>
                </label>
               <!-- </div> -->
               <br>
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.productionorder_required" @change="changeMovesTypes('rqorder', objInfo);">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Requiere Orden de Producción?</span>
                </label>
               <br>
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.consume_components" @change="changeMovesTypes('cons_comp', objInfo)">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Consumir Automáticamente los Componentes del Producto?</span>
                </label>
                <label class="switcher switcher-success mt-2">
                    <input type="checkbox" class="switcher-input" v-model="objInfo.ubications_movs" @change="changeMovesTypes('ubication_movs', objInfo)">
                    <span class="switcher-indicator">
                    <span class="switcher-yes"><span class="ion ion-md-checkmark"></span></span>
                    <span class="switcher-no"><span class="ion ion-md-close"></span></span>
                    </span>
                    <span class="switcher-label">Movimiento entre Ubicaciones Fisicas?</span>
                </label>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            /// Columnas de las tablas
                columns: [
                    ...
                    {key:'is_income', label:"Es Ingreso"},
                    {key:'edit', label:"Edit"}
                ],
            /// Columnas de las tablas
        ...
        methods:{
            changeMovesTypes(element, item){
                if(element == "ubication_movs"){
                        this.is_delivery = false
                        this.objInfo.warehouse_required=false
                        this.objInfo.productionorder_required=false
                        this.objInfo.consume_components=false
                }else if(element == "cons_comp"){
                    if(item.consume_components){
                        this.is_delivery = false
                        this.objInfo.warehouse_required=false
                        this.objInfo.productionorder_required=false
                        this.objInfo.ubications_movs=false
                    }
                }else if(element == "rqorder"){
                    if(item.productionorder_required){
                        this.is_delivery = false
                        this.objInfo.warehouse_required=false
                        this.objInfo.consume_components=false
                        this.objInfo.ubications_movs=false
        ...
        ///Funcion para reiniciar los datos
            restartInfo(){
                 this.objInfo= {
                    ...
                    productionorder_required:false,
        ...
        ///Eventos CRUD
            submit: function(){
                if(this.validate_content()){
                    infosysconfig.movtype(this.objInfo, "action").then(data => {
                        if (data.status === 202){
            ...
            deleteRecord: function(){
                infosysconfig.movtype(this.objInfo, "delete").then(data => {
                    if (data.status === 202){
