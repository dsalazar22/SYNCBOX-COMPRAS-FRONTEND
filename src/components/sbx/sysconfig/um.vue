<template>
    <div>
        ...
        <h4 class="font-weight-bold py-3 mb-4">Unidades de Medida</h4>
                ...
                <b-table small show-empty stacked="md" :items="tableData" :fields="columns" :current-page="currentPage" :per-page="perPage" 
                 ...
                 <div class="d-flex justify-content-between">
                    ...
                    <div class="text-muted">
                        <small> Total Unidad de Medida: {{this.totalRows}} </small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <b-modal id="modals-top" v-model="showFormulario"  class="modal-center" size="md">
            ...
            Administrar <span class="font-weight-light">Unidades de Medida</span><br>
            ...
            <fieldset class="demo-vertical-spacing-sm">
                ...
                <b-form-group :feedback="objState.message" label="Factor">
                    <b-input placeholder="Factor" v-model.trim="objInfo.factor"/>
                </b-form-group>
                <b-form-group :feedback="objState.message" label="Redondeo">
                    <b-input placeholder="Redondeo" v-model.trim="objInfo.rounding"/>
                </b-form-group>
            </fieldset>
