<template>
  <div>
    <div class="media align-items-center py-3 mb-3">
      <img :src="`/static/img/avatars/${userData.avatar}`" alt="" class="d-block ui-w-100 rounded-circle">
      <div class="media-body ml-4">
        ...
        <b-btn variant="primary" size="sm">Editar</b-btn>&nbsp;
        <b-btn variant="default" size="sm">Perfil</b-btn>&nbsp;
        ...
        <table class="table user-view-table m-0">
          <tbody>
            ...
            <tr>
              <td>Role:</td>
              <td>
                <span v-if="userData.role === 1">Usuario</span>
                <span v-if="userData.role === 2">Autorizado</span>
                <span v-if="userData.role === 3">Personal</span>
            ...
            <tr>
              <td>Estado:</td>
              <td>
                <b-badge variant="outline-success" v-if="userData.status === 1">Activo</b-badge>
                <b-badge variant="outline-danger" v-if="userData.status === 2">Inactico</b-badge>
                <b-badge variant="outline-default" v-if="userData.status === 3">Eliminado</b-badge>
              </td>
            </tr>
          </tbody>
        </table>
